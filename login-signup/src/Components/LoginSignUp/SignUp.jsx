...
function SignUp() {
  ...
  <form class="p-5 bg-white rounded-lg">
    ...
    <input type="submit" value="SignUp" class="w-full p-3 bg-blue-500 border-none text-white text-base font-bold rounded-md cursor-pointer shadow-md transition duration-300 ease-in-out hover:bg-blue-400 hover:shadow-lg" />
  </form>
</div>
  )
}
